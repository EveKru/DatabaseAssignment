...
{
    public readonly AdressRepository _adressRepository = adressRepository;
    ...
    public IEnumerable<AdressEntity> GetAll()
    {
    ...
    {
        var updated = _adressRepository.Update(x => x.Id == adressEntity.Id, adressEntity);
        return updated;
    }
